...
const EventDetailItem = ({ icon, alt, label }: { icon: string; alt: string; label: string }) => (
    <div className="flex-row-gap-2 items-center">
        <Image src={icon} alt={alt} width={19} height={19} />
        <p>{label}</p>
    </div>
);
            ...
            <div className="details">
                ...
                <aside className="booking">
                    ...
                    <div className="signup-card">
                        ...
                        {bookings > 0 ? (
                            <p className="text-sm">
                                Join {bookings} people who have already booked their place
                            </p>
                        ) : (
                            <p className="text-sm">Be the first to book your place</p>
                        )}
